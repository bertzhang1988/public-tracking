...
public class ShipmentSearchPage2 {

	

	WebDriver driver;
    public ShipmentSearchPage2(WebDriver driver)
    {
       this.driver = driver;
   ...
   public WebElement TrackNumInputBar;
  
   @FindBy(how = How.CSS, using = "small.help-block")
   ...
   @FindBy(how = How.XPATH, using = ".//*[@id='#notFound']/div")
  ...
  // @FindBy(how = How.XPATH ,using = "html/body/div[3]/div[2]/div/div/div/div[2]/div/div[1]/div[2]/ul")
   ...
   //@FindBy(how = How.CLASS_NAME, using = "table table-center table-hover")
   @FindBy(how = How.CSS, using = ".table.table-center.table-hover")
  // @FindBy(how = How.XPATH, using = "html/body/div[3]/div[2]/div/div/div/div[2]/div/form/div/table")
  // @FindBy(how = How.XPATH, using = ".//*[@id='shipmentSelectionPanel']/table")
   ...
   @FindBy(how = How.CSS, using = ".panel-title")
   public WebElement ShipmentDetailTitle;
   
   @FindBy(how = How.XPATH, using = ".//*[@id='ember1789']/a[4]/span")//"html/body/div[3]/div[2]/div/div/div/div[2]/div/div/div[1]/div[1]/div/a[4]/span")
   ...
   @FindBy(how = How.XPATH, using = ".//*[@id='ember1789']/a[2]/span")//"html/body/div[3]/div[2]/div/div/div/div[2]/div/div/div[1]/div[1]/div/a[2]/span")
   public WebElement EmailIcon;
   
   @FindBy(how = How.XPATH, using = ".//*[@id='ember1789']/a[1]/span")//"html/body/div[3]/div[2]/div/div/div/div[2]/div/div/div[1]/div[1]/div/a[1]/span")
   public WebElement NotificationIcon;

   @FindBy(how = How.XPATH, using = ".//*[@id='shipmentDetailPanel']/div[2]/div[1]/div[1]/p")
   ...
   @FindBy(how = How.XPATH, using = ".//*[@id='shipmentDetailPanel']/div[2]/div[1]/div[2]/p")                                  
   ...
   @FindBy(how = How.XPATH, using =".//*[@id='emailModal']/div[2]/div/div/h4")// "html/body/div[3]/div[2]/div/div/div/div[2]/div/div/div[2]/div/div[2]/div/div/h4")
   public WebElement EmailPageTitle;
   
   @FindBy(how = How.XPATH, using =".//*[@id='ember1809']/button")// "html/body/div[3]/div[2]/div/div/div/div[2]/div/div/div[2]/div/div[2]/div/form/div[2]/div/button")
   public WebElement SendEmailButton;

   @FindBy(how = How.XPATH, using =".//*[@id='emailModal']/div[2]/div/div/a/span") // "html/body/div[3]/div[2]/div/div/div/div[2]/div/div/div[2]/div/div[2]/div/div/a/span")
